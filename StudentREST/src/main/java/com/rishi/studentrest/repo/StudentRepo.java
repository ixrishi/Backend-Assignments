package com.rishi.studentrest.repo;
...
public class StudentRepo {
    ...
    public StudentRepo(){
        students.add(new StudentModel(1, "Rishi", 22));
        students.add(new StudentModel(2, "Rahul", 21));
        students.add(new StudentModel(3, "Ankit", 23));
